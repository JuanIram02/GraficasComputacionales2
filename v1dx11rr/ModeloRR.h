...
public:
	...
	ModeloRR(ID3D11Device* D3DDevice, ID3D11DeviceContext* D3DContext, char* ModelPath, WCHAR* colorTexturePath, WCHAR* normalTexturePath, WCHAR* specularTexturePath, float _posX, float _posZ)
	{
